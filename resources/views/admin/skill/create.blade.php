...
@section('content')
    <div class="content-wrapper">
        ...
        <x-custom.header-page title="{{ __('buttons.create_skill') }}" />
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">{{ __('buttons.create') }}<small>
                                        {{ __('attributes.skill') }}</small></h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form id="form1" action="{{ route('admin.skill.store') }}" method="POST"
